...
- Open the browser and navigate to `http://localhost:8501`, all the default configurations are been selected
- Select the charts which you want to display during the predictions.
