...
COMET_PROJECT_NAME = config[type_env]['project_name_final_test']
...
def download_models():
    ...
    list_of_models = ["neural-network-model", "linearmodel-angle", "linearmodel-distance", "linearmodel-angle-distance"]
...
# comet_exp_obj.log_notebook("q7_final_evaluation_testing.py")
